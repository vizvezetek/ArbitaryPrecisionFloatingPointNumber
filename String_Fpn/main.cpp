...
{ 
    // example: +34.12(...)-26.54(...)
    return getRandInRangeWithPrec(2, 100) + getRandInRangeWithPrec(2, 100); 
}
...
{ 
	...
	{ 
		...
		cout<< "x1: "<< clearFpnStr( population[0].chromosome.substr(0,52)) <<" x2: "<< clearFpnStr( population[0].chromosome.substr(52,52) ) <<"\t"; 
